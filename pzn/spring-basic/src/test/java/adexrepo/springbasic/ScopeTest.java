...
import adexrepo.springbasic.config.ScopeConfiguration;
...
public class ScopeTest {
    ...
    @Test
    void testDobletonScope(){

        Bar bar1 = applicationContext.getBean(Bar.class); // access else
        Bar bar2 = applicationContext.getBean(Bar.class); // access else
        Bar bar3 = applicationContext.getBean(Bar.class); // access if
        Bar bar4 = applicationContext.getBean(Bar.class); // access if
        // the result just can create new bean bar two times
